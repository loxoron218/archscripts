## Some packages from the AUR don't create automatically desktop icons their apps. Whith these commands you can download icons and create desktop entries for those apps.
